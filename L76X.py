...
class L76X(object):
    ...
    def L76X_Send_Command(self, data):
        ...
        self.config.Uart_SendByte(b'\r')
        self.config.Uart_SendByte(b'\n')
        print(data)
    ...
    def Baidu(self):
        self.Lat_Baidu, self.Lon_Baidu = self.wgs84_to_gcj02(self.Lat, self.Lon)
        self.Lon_Baidu = self.Lon_Baidu
        self.Lat_Baidu = self.Lat_Baidu

    def Google(self):
        self.Lat_Goodle, self.Lon_Goodle = self.wgs84_to_gcj02(self.Lat, self.Lon)
